	...
	public static class GameProcMain
	{
		...
		private static void Main4()
		{
			...
			if (ProcMain.DEBUG)
			{
				...
				logSaveDir = @"C:\temp";
				logFile = @"C:\temp\Play.log";
				saveDataFile = @"C:\temp\Play_" + solutionDirName + ".dat";
#else
			...
			else
			{
				...
				logFile = Path.Combine(ProcMain.SelfDir, "Play.log");
				saveDataFile = Path.Combine(ProcMain.SelfDir, "Play.dat");
			}
